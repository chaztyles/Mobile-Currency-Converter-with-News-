...
@Component({
  ...
  templateUrl: './changetarget.page.html',
  styleUrls: ['./changetarget.page.scss'],
})
export class ChangetargetPage implements OnInit {

  public title : string = 'Change Target Currency';
...
applySearchFilter() {
  ...
  onItemClick(currencyCode: string) {
    ...
    localStorage.setItem('targetCurrency', this.currencyCode);

    this.currencyDataService.notifySelectedTargetCurrency();
