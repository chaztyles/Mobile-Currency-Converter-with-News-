...
@Component({
  selector: 'app-editbase',
  templateUrl: './editbase.page.html',
  styleUrls: ['./editbase.page.scss'],
})
export class EditbasePage implements OnInit {

  public title : string = 'Edit Base Currency';
...
applySearchFilter() {
  ...
  onItemClick(currencyCode: string) {
    ...
    this.currencyDataService.setSelectedCurrencyCode(currencyCode);
    localStorage.setItem('firstBaseCurrency', currencyCode);
    this.currencyCode = currencyCode;

    // Notify subscribers about the updated currency code
    this.currencyDataService.notifyCurrencyCodeUpdated();
